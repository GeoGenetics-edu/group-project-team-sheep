...
#SBATCH --output=/maps/projects/course_1/scratch/group1/group-project-team-sheep/logs/bakta_%x_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group1/group-project-team-sheep/logs/bakta_%x_%j.err
...
OUT_DIR="/maps/projects/course_1/scratch/group1/group-project-team-sheep/09_annotation_bakta_ref/"
